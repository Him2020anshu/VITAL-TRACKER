...
const Footer = () => {
  return (
    <footer>
      <Container>
        <span>© 2024 Made with ❤️ by Bhuwan Bhaskar. All Rights Reserved.</span>
        <Wrapper>
          <div>
            <a
              href="https://www.linkedin.com/in/bhuwan-bhaskar-61781837a/" target="_blank">
              <Image src="https://images.seeklogo.com/logo-png/48/1/linkedin-logo-png_seeklogo-480553.png" />
            </a>
          </div>
          {/* <div>
...
{/* 
          ...
          <div>
            <a href="https://github.com/bbaspkrrj08" target="_blank">
